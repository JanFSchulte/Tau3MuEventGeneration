...
# with command line options: --python_filename DsTau3Mu_GEN-SIM_DIGI_RAW_PU0_cfg.py --eventcontent FEVTDEBUGHLT --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI-RAW --fileout file:Tau3Mu_GEN-SIM-DIGI-RAW_PU0.root --conditions auto:phase2_realistic --step DIGI,L1TrackTrigger,L1,DIGI2RAW,HLT:@fake2 --geometry Extended2026D88 --nStreams 3 --filein file:Tau3Mu_GENSIM.root --era Phase2C17I13M9 --no_exec --mc -n -1
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:Tau3Mu_GENSIM.root'),
