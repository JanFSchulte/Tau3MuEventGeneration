...
config.General.requestName     = 'BuTau3Mu_Pythia8_v2'
config.General.workArea        = 'crab'
config.General.transferOutputs = True
config.General.transferLogs    = False
config.JobType.maxMemoryMB = 3500
config.JobType.pluginName  = 'PrivateMC'
config.JobType.psetName    = 'BuTau3Mu_GEN_SIM_cfg.py'
config.Data.splitting   = 'EventBased'
config.Data.unitsPerJob = 25000
config.Data.totalUnits  = 200000000
config.Data.outLFNDirBase = '/store/user/jschulte/'
config.JobType.outputFiles  = ['BuTau3Mu_GEN_SIM.root']
config.Data.publication = True
config.Data.outputPrimaryDataset = 'BuTau3Mu_14TeV_Pythia8'
