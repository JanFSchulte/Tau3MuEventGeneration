...
# with command line options: Configuration/GenProduction/python/BPH-Run3Summer23GS-00054-fragment.py --python_filename BuTau3Mu_GEN_SIM_cfg.py --eventcontent FEVTDEBUG --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:BuTau3Mu_GEN_SIM.root --conditions 140X_mcRun4_realistic_v4 --beamspot HLLHC14TeV --step GEN,SIM --geometry Extended2026D110 --era Phase2C17I13M9 --no_exec --mc -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BPH-Run3Summer23GS-00054-fragment.py nevts:10'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BuTau3Mu_GEN_SIM.root'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.BpFilter+process.decayfilter)
